...
FilenameWindow::FilenameWindow()
{
    ...
    filenameBox.setPosition(filenameTyper.getPosition().x + filenameTyper.getGlobalBound().width/2,filenameTyper.getPosition().y + filenameTyper.getGlobalBound().height + 40);
}
